...
class ForwardedFilesScreen extends StatefulWidget {
  const ForwardedFilesScreen({super.key});

  @override
  State<ForwardedFilesScreen> createState() => _ForwardedFilesScreenState();
}

class _ForwardedFilesScreenState extends State<ForwardedFilesScreen> {
  @override
